...
const Setup = (): ReactElement => {
  ...
  const createStepCompletedSubject = (): Subject<boolean> => {
    ...
    subject.subscribe(
      (value) => value && setActiveStep((prevActiveStep) => prevActiveStep + 1)
    );
    return subject;
  };
  ...
  const steps: SetupStep[] = [
    {
      ...
      component: (
        <ChangePassword isSetup passwordUpdatedSubject={stepCompletedSubject} />
      ),
    },
    {
      label: "Write down mnemonic phrase",
      component: <MnemonicPhrase onCompleteSubject={stepCompletedSubject!} />,
    },
    {
      label: "Choose backup directory",
      component: <BackupDirectory onCompleteSubject={stepCompletedSubject} />,
    },
  ];
