...
const ChangePassword = (props: ChangePasswordProps): ReactElement => {
  const classes = useStyles();
  const { isSetup, passwordUpdatedSubject } = props;
  ...
  return (
    <>
      ...
      >
        {!!error && (
          <ErrorMessage
            mainMessage={`Failed to ${isSetup ? "create" : "change"} password`}
            details={error}
          />
        )}
        {success && !isSetup && <SuccessMessage message="Password updated" />}
      </Grid>
      <ActionButtons
